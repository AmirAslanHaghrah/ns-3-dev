 ...
 *
 * Converted to type 1 fuzzy handover algorithm interface by:
 * - Amiraslan Haghrah <amiraslanhaghrah@gmail.com>
 */

#include "fuzzy-type1-handover-algorithm.h"
#include <ns3/log.h>
...
NS_LOG_COMPONENT_DEFINE ("Type1FuzzyHandoverAlgorithm");

NS_OBJECT_ENSURE_REGISTERED (Type1FuzzyHandoverAlgorithm);
...
Type1FuzzyHandoverAlgorithm::Type1FuzzyHandoverAlgorithm ()
  : m_a2MeasId (0),
    m_a4MeasId (0),
    ...
    m_handoverManagementSapUser (0)
{
  ...
  m_handoverManagementSapProvider = new MemberLteHandoverManagementSapProvider<Type1FuzzyHandoverAlgorithm> (this);
}
...
TypeId
Type1FuzzyHandoverAlgorithm::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::Type1FuzzyHandoverAlgorithm")
    .SetParent<LteHandoverAlgorithm> ()
    .SetGroupName("Lte")
    .AddConstructor<Type1FuzzyHandoverAlgorithm> ()
    .AddAttribute ("ServingCellThreshold",
                   ...
                   UintegerValue (34),
                   MakeUintegerAccessor (&Type1FuzzyHandoverAlgorithm::m_servingCellThreshold),
    ...
    .AddAttribute ("NeighbourCellOffset",
                   ...
                   UintegerValue (1),
                   MakeUintegerAccessor (&Type1FuzzyHandoverAlgorithm::m_neighbourCellOffset),
...
void
Type1FuzzyHandoverAlgorithm::SetLteHandoverManagementSapUser (LteHandoverManagementSapUser* s)
{
...
Type1FuzzyHandoverAlgorithm::GetLteHandoverManagementSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
Type1FuzzyHandoverAlgorithm::DoInitialize ()
{
  NS_LOG_FUNCTION (this);
...
void
Type1FuzzyHandoverAlgorithm::DoDispose ()
{
  NS_LOG_FUNCTION (this);
  // Clean up
  Py_DECREF(pName);
...
void
Type1FuzzyHandoverAlgorithm::DoReportUeMeas  (uint16_t rnti,
